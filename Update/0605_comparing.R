...
plot(data, ylim=c(-0.02,0.18), xlim=c(0,0.40),ylab='Mean Return', xlab='Risk', cex=0.6) # main : 
lines(data)
points (0.045,0.1208, pch=4, col='red') # EW
points( 0.0434,0.0625, pch=5, col='red') # index

abline(v=0.2253, lty=2)
legend('topright', legend=c('SLOPE_30', 'EW', 'Index'), pch=c(1,4,5), col=c('black', 'red', 'red'), cex=rep(0.8,3))
